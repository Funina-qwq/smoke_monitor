...
class DatasetInfo(object):
    dataset_info = {
        ...
        'smoke_train': {
            'name': 'coco',
            'image_dir': 'data/smoke/train',
            'anno_dir': 'data/smoke/annotations/train.json',
            'split': 'train'
        },
        'smoke_val': {
            'name': 'coco',
            'image_dir': 'data/smoke/val',
            'anno_dir': 'data/smoke/annotations/val.json',
            'split': 'val'
        },
        'smoke_test': {
            'name': 'coco',
            'image_dir': 'data/smoke/test',
            'anno_dir': 'data/smoke/annotations/test.json',
            'split': 'test'
        },
        'sbd_train': {
            'name': 'sbd',
